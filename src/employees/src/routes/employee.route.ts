...
const {updateEmployeeByID, createEmployee, deleteEmployeeByID, getEmployeeById, getEmployees, addFace} = require('../controllers/employee.controller')
...
router.route('/api/employees/face-regis').post(verifyToken, addFace);
