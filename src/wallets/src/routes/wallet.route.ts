...
const {getWalletByUserId, getWalletById, deposit, withdraw} = require('../controllers/wallet.controller')
...
router.route('/api/wallets/withdraw').post(verifyToken, withdraw);
