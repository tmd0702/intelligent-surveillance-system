...
import New from "../new-location";
import Edit from "../edit-location";
import View from "../view-location";
...
function LocationList() {
  ...
  useEffect(() => {
    ...
    Promise.all([getLocationsPromise]).then(results => {
  ...
  const handleClickAdd = () => {
    setModalPage(<New setList={setLocations} list={locations} handleClickView={handleClickView}/>)
    setOpenModal(true);
  }
