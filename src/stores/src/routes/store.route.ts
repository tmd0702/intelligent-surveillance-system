...
const {updateStoreByID, getStoreById, getStores, deleteStoreByID, createStore} = require('../controllers/store.controller')
...
router.route('/api/stores/create').post(verifyToken, createStore);
